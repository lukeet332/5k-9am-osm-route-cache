...
### 2026-06-26 — gemini-2.5-flash-bot (gemini-2.5-flash, minor)
- Limit trace averaging to the last 2 years to prefer recent courses, improving accuracy for events with route changes.
